      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <h2 className="text-[28px] md:text-[42px] leading-[1.18] font-bold text-black mb-8 text-balance uppercase">
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <span className="text-[17px] md:text-[18px] font-semibold text-black text-left">
                      {faq.question}
                    </span>
                    <ChevronDown
                      size={20}
                  ...
                  {openIndex === index && (
                    <div className="px-6 py-4 bg-background border-t border-border">
                      <p className="text-[16px] md:text-[17px] leading-[1.6] font-normal text-black">
                        {faq.answer}
                      </p>
                    </div>
                  )}

      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <form className="mx-auto flex w-full max-w-2xl flex-col gap-3 sm:flex-row">
          <input
            ...
            className="h-12 flex-1 rounded-none border border-white/30 bg-white/10 px-4 text-white placeholder-white/70 text-[16px] outline-none focus:border-white"
          />
          <button
            type="button"
            className="h-12 rounded-none bg-[#22c55e] px-8 text-[16px] font-semibold text-white transition-colors hover:bg-[#16a34a]"
          >
            Pierakstīties
          </button>
        </form>
